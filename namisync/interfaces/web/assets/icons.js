...
const GLYPH_CLASSES = Object.freeze({
  ...
  "arrow-reset": "nami-icon--arrow-reset",
  ...
  "chevron-down": "nami-icon--chevron-down",
  "chevron-left": "nami-icon--chevron-left",
  "chevron-right": "nami-icon--chevron-right",
  "chevron-up": "nami-icon--chevron-up",
