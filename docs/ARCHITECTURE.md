...
| Safe integer, signed-64, canonical scalar/file-index codecs, typed review-limit facts, independent plan-source gates, exact scan detachment, and final shallow-slot admission | `namisync/core/scalars.py`, `namisync/core/review.py` |
