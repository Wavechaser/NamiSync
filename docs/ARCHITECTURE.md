...
| Safe integer, signed-64, canonical scalar/file-index codecs, typed review-limit facts, and plan-source admission accounting | `namisync/core/scalars.py`, `namisync/core/review.py` |
