...
Checkpoints 4–12 remain pending. NamiSync remains version
`0.1.0` until
...
| Second-half protocols/task foundation | revised BR-G-32 command table, BR-G-36, BR-G-41, BR-G-45, BR-G-46 command-map, and BR-G-48 foundations | recording/exact protocol complete; task foundation pending |
