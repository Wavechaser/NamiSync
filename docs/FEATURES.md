...
- **Progress and Cancellation**. Execution reports overall and per-file byte progress and checks pause/cancellation between operations, at adaptive copy-chunk admission, and while a bounded pipeline is backpressured.
