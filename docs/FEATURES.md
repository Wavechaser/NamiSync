...
non-sliding 150 ms progress-only linger have landed. Realigned SH-G-8 remains
open for calibrated, independently held-out Python transport custody. BR-G-45
separately keeps the 100,000-subject terminal artifact set and aggregate completed-task
