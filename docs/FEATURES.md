...
- **Task Rail**. The transparent rail exposes the window's Mica or opaque
  ...
  or wait. `BRIDGE.md` and `DEFENSE.md` §1.3 own exact lifetime and
  containment rules.
