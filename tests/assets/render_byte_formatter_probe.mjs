...
const cases = new Map([
  ...
  [String(120n * 1024n ** 2n), "120.0 MiB"],
  [String(10n * 1024n ** 2n + 512n * 1024n), "10.50 MiB"],
  ["10485236", "10.00 MiB"],
  [String(1023n * 1024n + 512n), "1.000 MiB"],
  ["9007200168568816", "8.000 PiB"],
  [String(2n ** 60n), "1.000 EiB"],
  [String(2n ** 63n - 1n), "8.000 EiB"],
]);
...
assert.equal(formatByteCount(1536), "1.500 KiB");
assert.equal(formatByteCount(1536n), "1.500 KiB");
