...
DEPARTMENTS: dict[str, tuple[str, ...]] = {
    ...
    "interfaces": (
        ...
        "tests/interfaces/web/test_plan_review.py",
        "tests/interfaces/web/test_plan_review_scale.py",
        "tests/interfaces/web/test_readiness.py",
        "tests/interfaces/web/test_shell_headed.py",
        "tests/interfaces/web/test_setup_headed.py",
